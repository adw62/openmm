#ifndef OPENMM_SYCLBONDEDUTILITIES_H_
#define OPENMM_SYCLBONDEDUTILITIES_H_
...
class OPENMM_EXPORT_COMMON SYCLBondedUtilities : public BondedUtilities {
public:
    SYCLBondedUtilities(OpenCLContext& context);
    /**
